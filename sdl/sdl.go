...
func (j *Joystick) setCJoystick(cJoystick unsafe.Pointer) {
	j.cJoystick = (*C.SDL_Joystick)(cJoystick)
}
...
func wrapJoystick(cJoystick *C.SDL_Joystick) *Joystick {
	...
	if cJoystick != nil {
		...
		joystick.setCJoystick(unsafe.Pointer(cJoystick))
		j = &joystick
	} else {
		j = nil
	}
...
func (joystick *Joystick) NumAxes() int {
	...
	num := int(C.SDL_JoystickNumAxes(joystick.cJoystick))
...
func (joystick *Joystick) Index() int {
	joystick.mutex.RLock()
	index := int(C.SDL_JoystickIndex(joystick.cJoystick))
	joystick.mutex.RUnlock()
	return index
}
...
func (joystick *Joystick) NumButtons() int {
	joystick.mutex.RLock()
	num := int(C.SDL_JoystickNumButtons(joystick.cJoystick))
	joystick.mutex.RUnlock()
	return num
}
...
func (joystick *Joystick) NumBalls() int {
	joystick.mutex.RLock()
	num := int(C.SDL_JoystickNumBalls(joystick.cJoystick))
	joystick.mutex.RUnlock()
	return num
}
...
func (joystick *Joystick) NumHats() int {
	joystick.mutex.RLock()
	num := int(C.SDL_JoystickNumHats(joystick.cJoystick))
	joystick.mutex.RUnlock()
	return num
}
...
func (joystick *Joystick) GetHat(hat int) uint8 {
	joystick.mutex.RLock()
	state := uint8(C.SDL_JoystickGetHat(joystick.cJoystick, C.int(hat)))
	joystick.mutex.RUnlock()
	return state
}
...
func (joystick *Joystick) GetButton(button int) uint8 {
	joystick.mutex.RLock()
	state := uint8(C.SDL_JoystickGetButton(joystick.cJoystick, C.int(button)))
	joystick.mutex.RUnlock()
	return state
}
...
func (joystick *Joystick) GetBall(ball int, dx, dy *int) int {
	joystick.mutex.RLock()
	state := int(C.SDL_JoystickGetBall(joystick.cJoystick, C.int(ball), (*C.int)(cast(dx)), (*C.int)(cast(dy))))
	joystick.mutex.RUnlock()
	return state
}
...
func (joystick *Joystick) GetAxis(axis int) int16 {
	joystick.mutex.RLock()
	state := int16(C.SDL_JoystickGetAxis(joystick.cJoystick, C.int(axis)))
	joystick.mutex.RUnlock()
	return state
}
